...
<head>
    ...
    <style>
    /* Dual date picker styling */
    .dual-date-wrap { display:flex; gap:6px; align-items:center; flex-wrap:wrap; }
    .dual-date-wrap .bs-date,.dual-date-wrap .ad-date { width:auto; min-width:130px; }
    .bs-label { font-size:.65rem; font-weight:700; color:#6c5ce7; text-transform:uppercase; }
    .ad-label { font-size:.65rem; font-weight:700; color:#0984e3; text-transform:uppercase; }
    </style>
</head>
<body>
...
<!-- MODULES -->
<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#mModules" role="button">
...
<!-- SETUP -->
<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#mSetup" role="button">
...
<!-- VEHICLES (mobile) -->
<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#mVehiclesMob" role="button">
        <i class="bi bi-truck"></i> Vehicles <i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <div class="collapse" id="mVehiclesMob">
        ...
        <a class="dropdown-item" href="<?= getUrl('vehicle/monthly_summary.php') ?>">Monthly Summary</a>
...
<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#mHRMob" role="button">
        <i class="bi bi-people"></i> HR <i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <div class="collapse" id="mHRMob">
        ...
        <a class="dropdown-item" href="<?= getUrl('hr/employee/department/index.php') ?>">Departments</a>
        ...
        <a class="dropdown-item" href="<?= getUrl('hr/modules/leaves/apply.php') ?>">Leave Applications</a>
...
<!-- REPORTS (mobile) -->
<li class="nav-item">
    <a class="nav-link" data-bs-toggle="collapse" href="#mReportsMob" role="button">
        <i class="bi bi-file-earmark-bar-graph"></i> Reports <i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <div class="collapse" id="mReportsMob">
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="<?= getUrl('hr/employee/index.php') ?>">
            <i class="bi bi-people-fill me-1"></i>Employee List</a></li>
        <li><a class="dropdown-item" href="<?= getUrl('hr/employee/create_enhanced.php') ?>">
            <i class="bi bi-person-plus me-1"></i>Add Employee</a></li>
        <li><a class="dropdown-item" href="<?= getUrl('hr/employee/department/index.php') ?>">
            <i class="bi bi-diagram-3 me-1"></i>Departments</a></li>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="<?= getUrl('attendance_device/zkteco_live.php') ?>">
            <i class="bi bi-fingerprint me-1"></i>ZKTeco Live</a></li>
        <li><a class="dropdown-item" href="<?= getUrl('attendance_device/attendance_report.php') ?>">
            <i class="bi bi-calendar-check me-1"></i>Attendance Report</a></li>
        <li><a class="dropdown-item" href="<?= getUrl('hr/modules/attendance/mark.php') ?>">
            <i class="bi bi-check2-square me-1"></i>Mark Attendance</a></li>
        <li><a class="dropdown-item" href="<?= getUrl('hr/modules/leaves/apply.php') ?>">
            <i class="bi bi-envelope me-1"></i>Leave Applications</a></li>
        <?php if (can_access_module('payroll')): ?>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="<?= getUrl('hr/modules/payroll/process.php') ?>">
            <i class="bi bi-cash-stack me-1"></i>Payroll</a></li>
        <?php endif; ?>
    </ul>
</li>
<?php endif; ?>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item" href="<?= getUrl('attendance_device/attendance_report.php') ?>">
            <i class="bi bi-file-pdf me-1"></i>Attendance PDF</a></li>
        <li><a class="dropdown-item" href="<?= getUrl('attendance_device/attendance_report.php?type=monthly') ?>">
...
<!-- Nepal Date JS — available on every page -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (openBtn)  openBtn.onclick  = () => { sidebar.classList.add('active'); overlay.classList.add('active'); document.body.style.overflow='hidden'; };
    ...
    sidebar.querySelectorAll('a.dropdown-item,a.nav-link').forEach(l => {
