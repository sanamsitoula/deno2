...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($action === 'create') {
            ...
            $required_fields = ['vehicle_no', 'vehicle_type', 'fuel_type', 'fuel_per_liter_standard', 'fiscal_year'];
            ...
            $stmt->execute([
               ...
               // Replace the 'created_by' required field check and use session instead
...
.badge-tractor { background: #e2d9f3; color: #4a235a; }
.badge-forklift { background: #fde8d8; color: #7d3c00; }
.form-container {
    background: white;
    border-radius: 12px;
    padding: 30px;
                    ...
                    <div class="form-group">
                        ...
                        <select name="vehicle_type" id="vehicle_type" class="form-control" required>
                            ...
                            <option value="generator" <?= ($edit_record && $edit_record['vehicle_type'] === 'generator') ? 'selected' : '' ?>>Generator</option>
                               <option value="tractor" <?= ($edit_record && $edit_record['vehicle_type'] === 'tractor') ? 'selected' : '' ?>>Tractor</option>
                               <option value="forklift" <?= ($edit_record && $edit_record['vehicle_type'] === 'forklift') ? 'selected' : '' ?>>Forklift</option>
