...
function printReport() {
    ...
    document.querySelectorAll("#reportTable tbody tr:not(.total-row)").forEach(function(row) {
        ...
        tableRows += `<tr>
            ...
            <td class="book-type ${typeClass}">${cells[3].innerHTML}</td>
            <td>${cells[4].textContent.trim()}</td>
            <td>${cells[5].textContent.trim()}</td>
            <td>${pokaQty}</td><td>${openpcs}</td><td>${totalQ}</td>
    ...
    var printContent = `<!DOCTYPE html><html><head>
        ...
        <style>
            *{margin:0!important;padding:0!important;box-sizing:border-box}
            ...
            body{font-family:Arial,sans-serif;margin:0!important;padding:10px!important;font-size:14px;line-height:1.2}
            ...
            .report-title{font-size:18px;font-weight:bold;margin-bottom:10px!important}
            .report-summary{margin:10px 0!important;border:1px solid #000;padding:10px!important;background:#f9f9f9;font-size:12px}
            .summary-row{display:flex;justify-content:space-between;margin:5px 0!important;font-size:12px}
            table{width:100%;border-collapse:collapse;margin-top:10px!important;font-size:12px}
            th,td{border:1px solid #000;padding:4px!important;text-align:center;font-size:12px;vertical-align:middle}
            th{background-color:#f0f0f0;font-weight:bold;padding:6px!important}
            .total-row{background-color:#e8f4f8;font-weight:bold}
            .total-row td{border-top:2px solid #000;font-size:13px;padding:5px!important}
            ...
            .signature-row{display:flex;justify-content:space-between;margin-top:20px!important}
            .signature-item{flex:1;text-align:center;margin:0 10px!important}
            .signature-item p{margin:8px 0!important;font-weight:bold;font-size:13px}
            .signature-line{border-bottom:1px solid #000;height:25px;margin:12px 5px!important}
            .signature-label{font-size:11px;color:#666;font-weight:normal!important}
            .footer{margin-top:15px!important;border-top:1px solid #000;padding-top:8px!important;font-size:11px;text-align:center}
        </style></head><body>
        <div class="header">
        ...
        <div class="report-summary">
            ...
            <div class="summary-row">
                ...
                <span><strong>तयार गरिएको:</strong> ${currentDateTime}</span>
            </div>${filterSummary}
        </div>
        <table><thead><tr>
        ...
        <div class="signature-section">
            <div class="signature-row">
                <div class="signature-item"><p><strong>रुजु गरी निकासा गर्ने:</strong></p><div class="signature-line"></div><p class="signature-label">हस्ताक्षर (Signature)</p><p>(उत्पादन विभाग)</p></div>
                <div class="signature-item"><p><strong>बुझिलिनेको सही:</strong></p><div class="signature-line"></div><p class="signature-label">हस्ताक्षर (Signature)</p><p>(उत्पादन विभाग)</p></div>
                <div class="signature-item"><p><strong>जाँच गर्ने (Verified By):</strong></p><div class="signature-line"></div><p class="signature-label">हस्ताक्षर (Signature)</p></div>
            </div>
        </div>
        <div class="footer"><p>रिपोर्ट तयार गरिएको मिति: ${currentDateTime}</p></div>
        </body></html>`;
