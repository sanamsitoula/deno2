...
function printReport() {
    ...
    // Create optimized print content with larger fonts and better visibility
    const printContent = `
        <!DOCTYPE html>
        <html>
        <head>
            ...
            <style>
                ...
                body {
                    ...
                    padding: 20px;
                    color: #333;
                    font-size: 16pt; /* 4x larger than previous 7pt */
                }
                .header {
                    text-align: center;
                    margin-bottom: 25px;
                ...
                th, td {
                    ...
                    padding: 8px 5px; /* Add padding for better readability */
                    text-align: center;
                    vertical-align: middle;
                }
                th {
        ...
        <body>
            <div class="header">
                <h2>JANAK EDUCATION MATERIALS CENTER</h2>
                <div class="report-title">Daily Production Report</div>
                <div class="report-period"><?= $nepali_months[$selected_month] ?> <?= $year ?></div>
            </div>
            <div class="table-container">
