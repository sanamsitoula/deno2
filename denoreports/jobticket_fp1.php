...
<head>
    ...
    <title>Forma Printing Records</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* Enhanced Responsive & Clean Styles */
        .container {
            max-width: 100%;
            padding: 20px;
        }
                ...
                <?php foreach ($forma_records as $record): ?>
                    <tr>
                        ...
                        <td class="no-print center">
                            <a href="forma_printing_view.php?id=<?= $record['id'] ?>" class="btn btn-primary btn-sm" title="View Details">
                                <i class="fas fa-eye"></i>
                            </a>
                            <?php if (has_role('editor') || has_role('admin')): ?>
                                <a href="forma_printing_edit.php?id=<?= $record['id'] ?>" class="btn btn-warning btn-sm" title="Edit Record">
