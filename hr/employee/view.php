    ...
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
           ...
           <div class="container-fluid">
            <!-- In Family Section -->
            <a href="family_create.php?emp_id=<?= $emp_id ?>" class="btn btn-sm btn-success">+ Add Family</a>

            <!-- In Education Section -->
            <a href="education_create.php?emp_id=<?= $emp_id ?>" class="btn btn-sm btn-success">+ Add Education</a>

            <!-- In Designation History -->
            <a href="designation_create.php?emp_id=<?= $emp_id ?>" class="btn btn-sm btn-success">+ Add Designation</a>

            <!-- In Documents -->
            <a href="document_create.php?emp_id=<?= $emp_id ?>" class="btn btn-sm btn-success">+ Upload Document</a>
        ...
        <div class="card shadow mb-4">
            <div class="card-body text-center">
                ...
                <p class="text-muted">
                    ...
                    <?= htmlspecialchars($employee['sub_department_name'] ?? '') ?> /
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-8"><?= date('F j, Y', strtotime($employee['created_date'])) ?></dd>
        ...
        <?php if (!empty($family_members)): ?>
            <h5 class="section-title"><i class="fas fa-users"></i> Family Members</h5>
        ...
        <?php if (!empty($education_list)): ?>
            <h5 class="section-title"><i class="fas fa-graduation-cap"></i> Education Background</h5>
            <div class="table-responsive mb-4">
        ...
        <?php if (!empty($designation_history)): ?>
            <h5 class="section-title"><i class="fas fa-history"></i> Designation & Department History</h5>
            <div class="table-responsive mb-4">
        ...
        <?php if (!empty($documents)): ?>
            <h5 class="section-title"><i class="fas fa-folder"></i> Uploaded Documents</h5>
            <div class="row">
