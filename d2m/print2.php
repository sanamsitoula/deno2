...
foreach ($logo_paths as $path) {
    if (file_exists($path)) {
        $logo_src = $base_url . str_replace($_SERVER['DOCUMENT_ROOT'], '', $path);
        // Verify the URL is accessible
        if (@get_headers($logo_src)) {
            break;
        }
    }
}
...
<head>
    ...
    <style>
        /* Override the header.php print styles */
        @media print {
            .jpms-layout .header,
            .jpms-layout .navbar-custom,
            #mobileMenuBtn,
            .print-button {
                display: none !important;
            }
            
            /* Ensure the report header is visible */
            .report-header {
        ...
        * {
        ...
        @media print {
            ...
            * {
            ...
            /* Ensure all text is black for better print visibility */
            .company-name,
            .company-name-english,
            .company-address,
            .report-title,
...
<body>
    ...
    <!-- Separate report header (will show during print) -->
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (logoImg && logoImg.src) {
                ...
                img.onerror = function() {
                    console.log('Logo failed to load, will use fallback');
                };
            }
            ...
            window.addEventListener('beforeprint', function() {
                ...
                document.querySelectorAll('.report-header, .logo-section, .logo').forEach(el => {
            ...
            // Override any print styles that might be hiding our report header
